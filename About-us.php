...
<body class="light-version">
   ...
   <?php include('page/header.php'); ?>
    ...
    <div class="st-bg">
        ...
        <section class="features section-padding-85">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="who-we-contant">
                            ...
                            <p class="wow fadeInUp" data-wow-delay="0.4s">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis at dictum risus, non suscipit arcu. Quisque aliquam posuere tortor, sit amet convallis nunc scelerisque in non suscipit arcu. Quisque.</p>
                            <p class="wow fadeInUp" data-wow-delay="0.5s">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nemo quo laboriosam, dolorum ducimus similique aliquam consequuntur saepe numquam suscipit praesentium saepe numquam suscipit similique!</p>
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="welcome-meter wow fadeInUp" data-wow-delay="0.7s">
                            <img src="img/svg/about2.svg" class="solution center-block" alt="">
        ...
        <section class="demo-video feat section-padding-0-100">
            <div class="container">
                <div class="section-heading text-center">
                    <!-- Dream Dots -->
                    <div class="dream-dots justify-content-center wow fadeInUp" data-wow-delay="0.2s">
